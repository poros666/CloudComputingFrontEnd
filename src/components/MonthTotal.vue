<template>
  <div class="warper">
    ...
    <div>
      <h1 class="HT">每月销售金额统计</h1>
      <h5 class="subT">Sales figures of every MONTH.</h5>
      <el-button
        ref="btn"
        class="btn"
        type="success"
    ...
    >
      ...
      <el-table-column prop="total" label="总计销售金额"> </el-table-column>
    </el-table>
  </div>
</template>
